  ...
  return (
    <>
      <div id="Blog-Info">
        ...
        <div>
          This is a blog that I will be updating every day for 100 days. The
          plan is to write a program a day for 100 days. Some Programs might be
          more then one day so i can learn the methodology aswell as implement
          it.
          <div>
            <div>The Github For this Projesct can be found here:</div>
            <a href="github>">Github</a>
            <div>Check Github Readme For File structure notes</div>
          </div>
        </div>
      </div>
      <div id="Blog-Posts">
        ...
        <div id="Post-2">
          ...
          <ul>
            ...
            <li> Database Organized 11/8/2022 </li>
            <li> Swapping to Pocketbase API 11/8/2022 </li>
          </ul>
